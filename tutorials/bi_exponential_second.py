...
from oscillation_decay_lmfit import fit_osc
...
class fit():
    ...
    def fft_data(self,event):
        ...
        fft_result = np.fft.fft(abs(self.sub))
        print(fft_result)
        ...
        ax[0].plot(self.new_ax,self.sub)
        ...
        s_signal=save_data(self.new_ax, self.sub,self.name+'_signal', [0.02,0.46],fig)
